...
class IEM_ellipse:
  def __init__(self, center, radii, boundary_type, N = 30, start = None, goal = None, other = None, ob_list = []):
  ...
  def plot_sample_points_inside(self):
      if self.other == True:
          ...
          n = 10; r = np.array(self.startgoal_radii)+[0.001,0.001]; c = self.start; ng = ellipse_grid_count(n, r, c)
